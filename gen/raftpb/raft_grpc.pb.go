...
const (
	RaftService_RequestVote_FullMethodName     = "/sqlraft.raft.RaftService/RequestVote"
	RaftService_AppendEntries_FullMethodName   = "/sqlraft.raft.RaftService/AppendEntries"
	RaftService_InstallSnapshot_FullMethodName = "/sqlraft.raft.RaftService/InstallSnapshot"
)
...
var RaftService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sqlraft.raft.RaftService",
